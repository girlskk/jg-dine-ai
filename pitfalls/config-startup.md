...
**历史**：threads/2026-03/20260306-charge-flow-e2e-pos-di-fix.md
...
**历史**：threads/2026-03/20260319-scheduler-periodic-config-binding-root-cause.md
...
**历史**：threads/2026-03/20260326-eventcore-local-startup-migration-debug.md
...
**历史**：threads/2026-03/20260330-dine-table-qrcode-h5-link.md, threads/2026-04/20260401-backend-dine-table-qrcode-config-split.md
...
**历史**：threads/2026-04/20260411-local-compose-startup-di-and-lifecycle-fixes.md

---

## HTTP 服务 Gin release 模式阻止日志污染

**何时撞见**：外部日志系统报 JSON parser 错误，包含 `[GIN-debug]` 和业务路由名。
**为什么**：8 个 HTTP 服务都按 `RunMode=dev -> gin.DebugMode`；开发阶段仍输出大量 `[GIN-debug]` 路由注册日志。
**怎么办**：所有服务统一强制 `gin.ReleaseMode`；`AppConfig.RunMode=dev` 仅控制 swagger/grpc-reflection 等业务能力开关，不控制 Gin 日志模式。新增 `pkg/ugin/mode.go` 的 `SetReleaseMode` helper。
**历史**：threads/2026-04/20260418-http-gin-release-mode-log-pipeline.md
